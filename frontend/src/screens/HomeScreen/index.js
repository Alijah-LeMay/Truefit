      ...
      <div className={classes.homeScreen_container}>
        ...
        <div className={classes.description_container}>
          ...
          <p>
            ...
            to fit your needs and your abilities, we can have you reaching your
            goals in no time! Not only do we want you to reach your goals and
            keep your results, we want to educate you along the way!
          </p>
        </div>
        ...
        <div className={classes.programs_container}>
          ...
          <ul>
            <li>
              Introductory video chat with Trainer Hannah to discuss your goals
            </li>
            <li>
          ...
          <ul style={{ listStyleType: 'decimal' }}>
            ...
            <li>You will start receiving your workouts and nutrition plan!</li>
          </ul>
        </div>
